...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/empty-waterfall-a6c1
```

A live public deployment of this template is available at [https://empty-waterfall-a6c1.templates.workers.dev](https://empty-waterfall-a6c1.templates.workers.dev)
